import { Card, List, Avatar, Icon, Tag, Progress, Row, Skeleton } from 'antd';
          ...
          renderItem={item => (
            <List.Item>
              ...
              <Card
                ...
                hoverable
                cover={<img height="200" width="200"
                            src={item.business.yelp == null ? defaultImage : item.business.yelp.image_url}/>}
